...
- Make sure that you have the yaml file in the correct location (yaml_file="$OSVAS/config_files/Stations/${STATION_NAME}/${STATION_NAME}.yml")
...
- Make sure that you have the namelist file in the correct location (yaml_file="$OSVAS/namelists/{STATION_NAME}/OPTIONS.nam_{EXPNAME}")
```
OSVAS_steps:
 Create_forcing: true
 Get_validation: true
